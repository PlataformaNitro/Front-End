    ...
    var favorito by remember{mutableStateOf(false)}
        ...
        Box(modifier = Modifier.fillMaxHeight(0.3f).fillMaxWidth()) {
            ...
            IconButton(
                ...
                Icon(
                    painter = painterResource(id = R.drawable.icone_de_saida),
        ...
        Surface(
            ...
            Box(
                ...
                Column(modifier = Modifier.fillMaxSize()) {
                    ...
                    Text(
                        text = "Estimativa: 1 hora", // Você pode modificar para algo dinâmico se quiser
                        style = TextStyle(
                            fontSize = 14.sp,
                            fontFamily = FontFamily(Font(R.font.archivo_black)),
                            fontWeight = FontWeight.W400,
                ...
                Row(
                    ...
                    Button(
                        ...
                        contentPadding = androidx.compose.foundation.layout.PaddingValues(1.dp, 1.dp)
                    ) {
                        Icon(
...
private fun PreviewTelaDeRedirecionamento() {
    val viajemTeste = Viajem(
        imagem = R.drawable.viajem_1,  // só para preview
        origem = "Rua Tito, Lapa",
        destino = "Parque da Cidade",
        descricao = "Nesse trajeto maravilhoso, a Rua Tito, Lapa se transforma em avenidas arborizadas que revelam paisagens naturais surpreendentes..."
    )
    TeladeRedirecionamento(viajem = viajemTeste)
}
